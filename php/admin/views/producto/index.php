...
<div class="bg-white w-100 container-fluid mx-auto">
        ...
        <div class="search_prod">
            <form method="get" action="../../controllers/producto/buscar.controllers.php">
                <div class="form-group d-flex">
                    ...
                    <button class="btn aqua-gradient btn-rounded btn-sm rounded px-3 fas fa-search" style="background: rgb(7, 42, 117); color: white" type="submit"></button>
                </div>
            </form>
        </div>
    </div>
        ...
        <?php if (count($productos)) : ?>
            <?php foreach ($productos as $producto) : ?>
                <div class="producto shadow">
                    ...
                    <a>
                        <img data-toggle="modal" data-target="#modal<?php echo $producto->id ?>" style="height: 370px; width: 200px" class="p-1 img-responsive z-depth-1 " src="../../../../img/<?php echo $producto->imagen ?>" alt="absolut">
                    </a>
                </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer" style="justify-content:space-between">
                                ...
                                <button type="button" class="btn btn-outline-primary btn-rounded btn-md ml-4 fas fa-times" data-dismiss="modal"></button>
                            </div>
                        </div>
                    </div>
                </div>
